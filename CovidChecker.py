...
# Read the excel file, and find the last row of data available, return that row number as a String
def getLastRowNumber(sheet):
...
def getLocationName(location):
    locationsList = getLocations(False)
...
newestDate = sheet.cell(row=lastRow, column=1)  # Get the data of the most available row of data
...
def testALL():
    ...
    print('--------------------')
    print()
    printNewestCasesOnly(lastRow)
    print()
    print('--------------------')
    print()
    print(getNewestCases(lastRow))
    print()
    print('--------------------')
    print()
    print(getLocations())
